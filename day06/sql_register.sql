...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 10, 2021 lúc 09:08 AM
...
CREATE TABLE `student` (
  ...
  `Birthday` char(4) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `student` (`ID`, `Name`, `Gender`, `Faculty`, `Birthday`) VALUES
(1, 'Đương Đình Nguyễn', 1, 'MAT', '2000'),
(58, 'Nguyễn Đình Đương', 1, 'DTS', '1998');
